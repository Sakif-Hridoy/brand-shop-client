...
//       <div className="navbar-start">
//         <div className="dropdown">
//           <div tabIndex={0} role="button" className="btn text-white btn text-white-ghost lg:hidden">
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               className="h-5 w-5"
//               fill="none"
...
//           </ul>
//         </div>
//         <a className="btn text-white btn text-white-ghost text-xl">Tech World</a>
//       </div>
//       <div className="navbar-center hidden lg:flex">
//         <ul className="menu menu-horizontal px-1">{links}</ul>
//       </div>
...
//         {googleUser && (
//           <button className="btn text-white mr-[30px]">
//             {googleUser.displayName}
//           </button>
//         )}
...
//             <button
//               onClick={handleSignOut}
//               className="btn text-white mr-[30px]"
//             >
//               Sign Out
//             </button>
...
//         ) : (
//           <Link to="/login">
//             <button className="btn text-white mr-[30px]">Log In</button>
//           </Link>
//         )}
//       </div>
//     </div>
