...
import image6 from "../assets/slide 6.png"
    ...
    <div>
      ...
      </h2>
      {
        ...
        <div className="carousel-item text-center">
          <img className="w-[400px] h-[400px]" src={image1} alt="Burger" />
          
        </div> 
        <div className="carousel-item">
          <img className="w-[400px] h-[400px]" src={image2} alt="Burger" />
        </div> 
        <div className="carousel-item">
          <img className="w-[500px] h-[400px]" src={image3} alt="Burger" />
        </div> 
        <div className="carousel-item">
          <img className="w-[400px] h-[400px]" src={image4} alt="Burger" />
        </div> 
        <div className="carousel-item">
          <img className="w-[400px] h-[400px]" src={image5} alt="Burger" />
        </div> 
        <div className="carousel-item">
          <img className="w-[400px] h-[400px]" src={image6} alt="Burger" />
        </div> 
        <div className="carousel-item">
          <img className="w-[400px] h-[400px]" src={image7} alt="Burger" />
        </div>
      </div>)
      }
    </div>
